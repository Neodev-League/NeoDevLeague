        ...
        case "mention":
          return (
            <a
              ...
              className="text-ms font-normal text-gray-500"
            >
      ...
      <div className="relative flex transform-gpu snap-x snap-mandatory gap-4 overflow-x-auto">
        ...
        {tweet.photos.map((photo) => (
          <img
            ...
            alt={tweet.text}
            className="h-64 w-5/6 shrink-0 snap-center snap-always rounded-xl border border-lighterGreen object-cover shadow-sm"
          />
        ))}
        <div className="shrink-0 snap-center sm:w-2" />
      </div>
    ...
    {!tweet.video &&
      ...
      tweet?.card?.binding_values?.thumbnail_image_large?.image_value.url && (
        <img
          ...
          className="h-64 rounded-xl border border-lighterGreen object-cover shadow-sm"
        />
      )}
  </div>
);
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col gap-2 overflow-hidden p-4 mb-[2vh] backdrop-blur-sm",
        className,
      )}
      {...props}
    >
