          ...
          >
            ...
            >
              ...
              <p className="text-white text-xl max-w-2xl">
                ...
                grow, and innovate. Through unique challenges, we're powering
                the next wave of tech visionaries.
              </p>
            </motion.div>
            ...
            >
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <p className="text-white text-lg">
                  Connect with tomorrow's tech leaders. Be part of redefining
                  the hackathon experience and ride the new tech wave with us.
                </p>
              </div>
            ...
            >
              ...
              <p className="text-green-100 text-lg">
                ...
                Toronto, London, and beyond – your brand visibility grows with
                our network.
              </p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl text-white">
                Join us in shaping the future of tech. Your sponsorship can make
                a difference in the lives of young programmers and innovators.
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
