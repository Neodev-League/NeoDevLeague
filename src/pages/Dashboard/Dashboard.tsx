    ...
    return (
        <div className="relative min-h-screen pb-16">
                    ...
                    <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-lg p-6 shadow-lg">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                                ...
                                <span className="text-xl text-white">School: Coming Soon!</span>
                            </div>
                            <div className="flex items-center">
                ...
                >
                    <div>
                        ...
                        <Button className="w-full mb-4 bg-gradient-to-r from-[#34D399] to-green-500 hover:from-[#34D399] hover:to-green-600 text-white text-lg py-6 transition-all duration-300 transform" >
                            <a className="flex flex-row items-center text-mms" href="https://discord.gg/ZvKXEKsuA7" target="_blank"><MessageCircle className="mr-2 h-6 w-6" /> Join Discord</a>
                        </Button>
                        <Button className="w-full mb-4 bg-gradient-to-r from-[#34D399] to-green-500 hover:from-[#34D399] hover:to-green-600 text-white text-lg py-6 transition-all duration-300 transform">
            ...
            <BottomBar>
                <Link
                    to="/dashboard"
                    className={`text-white hover:text-white transition-colors ${location.pathname === "/dashboard" ? "font-bold" : ""
                        }`}
                >
                    Dashboard
                </Link>
                <Link
                    ...
                    className={`text-white hover:text-white transition-colors ${location.pathname === "/dashboard-leaderboard" ? "font-bold" : ""
                        }`}
                >
                    Leaderboard
                </Link>
                <Link
                    ...
                    className={`text-white hover:text-white transition-colors ${location.pathname === "/dashboard-account" ? "font-bold" : ""
                        }`}
                >
                    Account
                </Link>
                <Link
                    ...
                    className={`text-white hover:text-white transition-colors ${location.pathname === "/dashboard-timeline" ? "font-bold" : ""
                        }`}
                >
                    Timeline
                </Link>
